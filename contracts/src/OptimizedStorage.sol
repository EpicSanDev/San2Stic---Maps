...
library OptimizedStorage {
    ...
    function packStats(uint256 upvotes, uint256 downvotes, uint256 totalRating, uint256 ratingCount) 
        internal pure returns (PackedStats memory) {
    ...
    function packUserStats(uint256 totalRecordings, uint256 totalVotes, uint256 reputation, uint256 registrationTimestamp) 
