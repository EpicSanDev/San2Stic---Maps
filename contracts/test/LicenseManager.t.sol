...
contract LicenseManagerTest is Test {
    ...
    function testInitialState() public {
        ...
        LicenseManager.LicenseInfo memory allRights = licenseManager.getLicenseInfo(LicenseManager.LicenseType.ALL_RIGHTS_RESERVED);
        ...
        LicenseManager.LicenseInfo memory publicDomain = licenseManager.getLicenseInfo(LicenseManager.LicenseType.PUBLIC_DOMAIN);
    ...
    function testCheckLicenseCompatibilityNoDerivatives() public {
        (bool compatible, string memory reason) = licenseManager.checkLicenseCompatibility(
            LicenseManager.LicenseType.CC_BY_ND,
            LicenseManager.LicenseType.CC_BY
        );
    ...
    function testCheckLicenseCompatibilityCommercial() public {
        (bool compatible, string memory reason) = licenseManager.checkLicenseCompatibility(
            LicenseManager.LicenseType.CC_BY_NC,
            LicenseManager.LicenseType.CC_BY
        );
        assertFalse(compatible);
