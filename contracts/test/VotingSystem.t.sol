...
contract VotingSystemTest is Test {
    ...
    event RecordingModerated(
        uint256 indexed recordingId, address indexed moderator, VotingSystem.ModerationStatus status
    );
    event ReputationUpdated(address indexed user, uint256 newReputation);
    event ModerationActionTaken(
        uint256 indexed recordingId, address indexed moderator, VotingSystem.ModerationStatus action, string reason
    );
